...
export const createReportByEmployeeValidationSchema = z.object({
  body: z.object({
    ...
    /*****
     * 🆕 based on this customerId .. we create customerReport relation .. so that 
     * customer can get this report in his/her app
     * **** */
    customerId : z.string({
        required_error: 'customerId is required, customerId must be a valid mongoose object id .',
